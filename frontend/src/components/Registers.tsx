              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-3 bg-gray-50 border rounded-lg focus:ring-2 focus:ring-black focus:border-transparent outline-none transition-all pr-12 ${
                      registerForm.password && registerForm.confirmPassword && registerForm.password !== registerForm.confirmPassword ? 'border-red-500' : 'border-gray-200'
                    }`}
                    required
                    minLength={6}
                    disabled={isLoading}
